...
const HOME_FAQ_COPY = {
  ...
  es: [
    ["¿Comprar sobre plano en Marrakech es realmente seguro?", "Comprar sobre plano puede ser interesante, pero solo si el proyecto se verifica correctamente. Antes de reservar, hay que analizar el promotor, las autorizaciones, los planos, el calendario de entrega, las modalidades de pago, los materiales anunciados y las garantías disponibles. El riesgo no procede de la compra sobre plano en sí, sino de un proyecto mal estudiado o mal documentado."],
    ["¿Qué significa S.A.F.E. antes de presentar un proyecto?", "S.A.F.E. — Security, Analysis, Fidelity & Expert Guidance es un marco independiente de análisis, preselección y seguridad inmobiliaria destinado a reforzar la protección y la comprensión de compradores e inversores. OFF MARKET no es propietario de S.A.F.E. ni reivindica su creación. OFF MARKET respeta y aplica los principios S.A.F.E. en su proceso de estudio y presentación de oportunidades inmobiliarias. S.A.F.E. constituye un marco independiente de análisis y seguridad inmobiliaria. Su aplicación no sustituye las verificaciones jurídicas, notariales, técnicas, fiscales o financieras necesarias antes de cualquier adquisición y no garantiza la ausencia total de riesgo."],
    ["Villa sobre plano o apartamento nuevo en Marrakech: ¿qué elegir?", "Una villa sobre plano conviene más a compradores que buscan espacio, jardín, piscina, mayor privacidad y una lógica patrimonial. Un apartamento nuevo en Marrakech encaja mejor con un uso céntrico, de alquiler o como pied-à-terre, especialmente en zonas como Guéliz o Hivernage. La elección adecuada depende del presupuesto, del uso previsto y del barrio."],
    ["¿Qué documentos revisar antes de reservar un proyecto inmobiliario sobre plano?", "Antes de reservar, conviene solicitar los planos, las autorizaciones, el título o los elementos jurídicos del terreno, la memoria de calidades, las modalidades de pago, el calendario de entrega, las condiciones de reserva y las garantías previstas. Un proyecto serio debe poder presentar un expediente claro antes de cualquier decisión."],
    ["¿Por qué OFF MARKET no presenta todos los proyectos disponibles?", "OFF MARKET no presenta un proyecto solo porque esté disponible o resulte atractivo visualmente. Cada oportunidad se estudia según su ubicación, promotor, expediente, prestaciones, precio y coherencia con el mercado. El objetivo es presentar menos proyectos, pero mejor filtrados."],
    ["¿Qué es el inmobiliario off-market en Marrakech?", "El inmobiliario off-market designa bienes o proyectos que no siempre se publican ampliamente en línea. En Marrakech puede incluir villas, apartamentos, terrenos, riads, comercios o proyectos sobre plano accesibles previa solicitud. Su interés es acceder a una selección más confidencial, a menudo antes de una difusión más amplia."],
  ],
  no: [
    ["Er det virkelig trygt å kjøpe nybygg på plan i Marrakech?", "Å kjøpe på plan kan være interessant, men bare dersom prosjektet er grundig kontrollert. Før reservasjon bør utvikleren, tillatelsene, planene, leveringsplanen, betalingsvilkårene, de oppgitte materialene og tilgjengelige garantier analyseres. Risikoen ligger ikke i kjøp på plan i seg selv, men i et prosjekt som er svakt undersøkt eller dårlig dokumentert."],
    ["Hva betyr S.A.F.E. før et prosjekt presenteres?", "S.A.F.E. — Security, Analysis, Fidelity & Expert Guidance er et uavhengig rammeverk for eiendomsanalyse, forhåndsutvelgelse og sikring, utformet for å styrke kjøperes og investorers beskyttelse og forståelse. OFF MARKET eier ikke S.A.F.E. og hevder ikke å ha skapt det. OFF MARKET respekterer og anvender S.A.F.E.-prinsippene i prosessen med å vurdere og presentere eiendomsmuligheter. S.A.F.E. er et uavhengig rammeverk for analyse og eiendomssikring. Bruken erstatter ikke nødvendige juridiske, notarielle, tekniske, skattemessige eller finansielle kontroller før et kjøp, og garanterer ikke fullstendig fravær av risiko."],
    ["Nybyggvilla eller ny leilighet i Marrakech: hva bør du velge?", "En nybyggvilla passer best for kjøpere som søker plass, hage, basseng, mer privatliv og en langsiktig formueslogikk. En ny leilighet i Marrakech passer bedre til sentral bruk, utleie eller som pied-à-terre, særlig i områder som Guéliz eller Hivernage. Riktig valg avhenger av budsjett, planlagt bruk og område."],
    ["Hvilke dokumenter bør kontrolleres før et nybyggprosjekt reserveres?", "Før reservasjon bør du be om planer, tillatelser, tittel eller juridiske elementer knyttet til tomten, leveransebeskrivelse, betalingsvilkår, leveringsplan, reservasjonsvilkår og de planlagte garantiene. Et seriøst prosjekt skal kunne legge frem en tydelig dokumentasjon før beslutning."],
    ["Hvorfor presenterer ikke OFF MARKET alle tilgjengelige prosjekter?", "OFF MARKET presenterer ikke et prosjekt bare fordi det er tilgjengelig eller visuelt attraktivt. Hver mulighet vurderes etter beliggenhet, utvikler, dokumentasjon, kvaliteter, pris og sammenheng med markedet. Målet er å presentere færre prosjekter, men prosjekter som er bedre filtrert."],
    ["Hva er off-market eiendom i Marrakech?", "Off-market eiendom viser til eiendommer eller prosjekter som ikke alltid publiseres bredt på nett. I Marrakech kan det gjelde villaer, leiligheter, tomter, riader, næringseiendom eller nybyggprosjekter som er tilgjengelige på forespørsel. Fordelen er tilgang til et mer konfidensielt utvalg, ofte før en bredere lansering."],
  ],
...
export function buildHomeFaqHtml(locale: SiteLocale = "fr"): string {
  ...
  const copy = {
    ...
    es: ["Comprar inmobiliario en Marrakech", "Las preguntas esenciales antes de estudiar una villa, un apartamento nuevo o un proyecto inmobiliario presentado por OFF MARKET."],
    ...
    no: ["Kjøpe eiendom i Marrakech", "De viktigste spørsmålene før du vurderer en villa, en ny leilighet eller et eiendomsprosjekt presentert av OFF MARKET."],
  }[locale];
