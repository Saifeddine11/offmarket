...
(function () {
  ...
  var TARGETS = [
    ...
    '#legacy-editorial #nature',
    '#legacy-editorial #l-place-content',
    '#legacy-editorial #l-place-sticky-1',
    '#legacy-editorial #l-place-sticky-2',
    '#legacy-editorial #l-place-sticky-3',
    '#legacy-editorial #design',
    '#legacy-editorial #l-design-sticky-2',
    '#legacy-editorial #l-design-sticky-3',
    '#legacy-editorial #l-residences-sticky-1',
    '#legacy-editorial #interiors',
