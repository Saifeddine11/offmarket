...
(function () {
  ...
  var PROPERTY_MODAL_TEXT_TRANSLATIONS = {
    ...
    es: {
      ...
      'Rappel': 'Llamada',
      'Recevoir le dossier': 'Recibir el expediente',
      'Villa sur plan': 'Villa sobre plano',
      'Sélection :': 'Selección:',
      'Projet sur plan': 'Proyecto sobre plano',
      'À partir de 351 000 €': 'Desde 351 000 €',
      '32 villas sur plan à Marrakech, avec une disponibilité limitée à 7 villas restantes.':
        '32 villas sobre plano en Marrakech, con disponibilidad limitada a 7 villas restantes.',
      'Villa Jaz — villas sur plan à Marrakech':
        'Villa Jaz — villas sobre plano en Marrakech',
      'Réserver ta villa': 'Reservar su villa',
      'Remplir le formulaire pour plus de détails': 'Completar el formulario para recibir más detalles',
      'Type': 'Tipo',
      'Total': 'Total',
      ...
      'Paiement': 'Pago',
      '32 villas': '32 villas',
      '7 villas restantes': '7 villas restantes',
      'Communiquée sur demande': 'Comunicada previa solicitud',
      '30% à la réservation, puis 30% à chaque avancement du projet':
        '30% en la reserva, luego 30% en cada avance del proyecto',
      'Villa Jaz est une opportunité sur plan pensée pour les acquéreurs qui recherchent une villa privée à Marrakech, avec un cadre résidentiel, des espaces extérieurs et une disponibilité volontairement limitée.':
        'Villa Jaz es una oportunidad sobre plano pensada para compradores que buscan una villa privada en Marrakech, con un entorno residencial, espacios exteriores y una disponibilidad voluntariamente limitada.',
      'Le projet réunit 32 villas, dont 7 restent disponibles. Les informations détaillées, les plans, les disponibilités actualisées et les conditions précises sont communiqués après formulaire afin de préserver la confidentialité du projet.':
        'El proyecto reúne 32 villas, de las cuales 7 siguen disponibles. La información detallada, los planos, la disponibilidad actualizada y las condiciones precisas se comunican tras el formulario para preservar la confidencialidad del proyecto.',
      '32 villas au total': '32 villas en total',
      'Prix à partir de 351 000 €': 'Precio desde 351 000 €',
      '30% à la réservation': '30% en la reserva',
      '30% à chaque avancement du projet': '30% en cada avance del proyecto',
      'Adresse communiquée sur demande': 'Dirección comunicada previa solicitud',
      'Plans sur formulaire': 'Planos mediante formulario',
      'Disponibilités actualisées': 'Disponibilidades actualizadas',
      'Détails complets sur demande': 'Detalles completos previa solicitud',
      'Réservation sur formulaire': 'Reserva mediante formulario',
      'Informations clés': 'Información clave',
      'Disponibilité limitée': 'Disponibilidad limitada',
      'sur 32 villas': 'de 32 villas',
      'Confort & équipements': 'Confort y equipamientos',
      'Piscine privée dans chaque villa': 'Piscina privada en cada villa',
      'Espaces verts paysagers': 'Zonas verdes paisajísticas',
      'Aire de jeux pour enfants': 'Zona de juegos infantiles',
      'Équipements haut de gamme': 'Equipamientos de alta gama',
      'Jardins et espaces extérieurs aménagés': 'Jardines y espacios exteriores acondicionados',
      'Confidentialité & réservation': 'Confidencialidad y reserva',
      'Résidence sécurisée': 'Residencia segura',
      'Sécurité et confidentialité': 'Seguridad y confidencialidad',
      'Modalités de paiement': 'Condiciones de pago',
      '30% à la réservation, puis 30% à chaque avancement du projet. Remplir le formulaire pour recevoir les détails complets.':
        '30% en la reserva, luego 30% en cada avance del proyecto. Complete el formulario para recibir todos los detalles.',
      'Détails sur demande': 'Detalles previa solicitud',
      'Modalités de paiement — 30% à la réservation. 30% à chaque avancement du projet. Pour recevoir les détails complets, les disponibilités exactes et les conditions actualisées, merci de remplir le formulaire.\n\nDisponibilité limitée — 7 villas restantes sur un total de 32 villas.':
        'Condiciones de pago — 30% en la reserva. 30% en cada avance del proyecto. Para recibir los detalles completos, la disponibilidad exacta y las condiciones actualizadas, complete el formulario.\n\nDisponibilidad limitada — 7 villas restantes de un total de 32 villas.',
      'Appartement': 'Apartamento',
      'À partir de 1,05 M MAD': 'Desde 1,05 M MAD',
      'Programme neuf sur plan': 'Programa nuevo sobre plano',
      'Appartement premium à Guéliz': 'Apartamento premium en Guéliz',
      'Studios, appartements, duplex et commerces en hyper-centre de Marrakech.':
        'Estudios, apartamentos, dúplex y locales comerciales en el hipercentro de Marrakech.',
      'Appartement premium à Guéliz — Guéliz hyper-centre, Marrakech':
        'Apartamento premium en Guéliz — hipercentro de Guéliz, Marrakech',
      'Réserver ton appartement': 'Reservar su apartamento',
      'Recevoir la fiche privée': 'Recibir la ficha privada',
      'Studio': 'Estudio',
      'Duplex': 'Dúplex',
      'Magasin commercial': 'Local comercial',
      'Programme neuf haut standing': 'Programa nuevo de alta gama',
      'Localisation': 'Ubicación',
      'Guéliz hyper-centre, Marrakech': 'Hipercentro de Guéliz, Marrakech',
      'Surfaces': 'Superficies',
      'Livraison': 'Entrega',
      '2028 — 1ère livraison': '2028 — primera entrega',
      'Programme immobilier neuf haut standing à Guéliz, avec studios, appartements, duplex et commerces. Une adresse sélectionnée pour acheter un bien neuf en hyper-centre de Marrakech.':
        'Programa inmobiliario nuevo de alta gama en Guéliz, con estudios, apartamentos, dúplex y locales comerciales. Una dirección seleccionada para comprar una propiedad nueva en el hipercentro de Marrakech.',
      'Positionnement': 'Posicionamiento',
      'Hyper-centre, à proximité immédiate des commerces, restaurants et services.':
        'Hipercentro, con proximidad inmediata a comercios, restaurantes y servicios.',
      'Conception': 'Diseño',
      'Une esthétique sobre, raffinée et intemporelle, inspirée des codes hôteliers haut de gamme.':
        'Una estética sobria, refinada e intemporal, inspirada en los códigos hoteleros de alta gama.',
      'Projet patrimonial': 'Proyecto patrimonial',
      'Un actif pensé pour habiter, préparer un pied-à-terre ou étudier une stratégie patrimoniale à Guéliz.':
        'Un activo pensado para vivir, preparar un pied-à-terre o estudiar una estrategia patrimonial en Guéliz.',
      'Piscines au rez-de-chaussée': 'Piscinas en planta baja',
      'Spa résidentiel': 'Spa residencial',
      'Jacuzzi': 'Jacuzzi',
      'Salle de sport': 'Gimnasio',
      'Vestiaires séparés hommes / femmes': 'Vestuarios separados hombres / mujeres',
      'Parking titré & box privatifs': 'Aparcamiento titulado y boxes privados',
      'Plans sur demande': 'Planos previa solicitud',
      'Riad': 'Riad',
      'Prix sur demande': 'Precio previa solicitud',
      'Riad privé': 'Riad privado',
      'Riad de caractère à la Médina': 'Riad con carácter en la Medina',
      'Médina · architecture · emplacement rare': 'Medina · arquitectura · ubicación rara',
      'Secteur': 'Sector',
      'Médina': 'Medina',
      'Style': 'Estilo',
      'Patrimoine': 'Patrimonio',
      ...
      'Patio': 'Patio',
      'Terrasse': 'Terraza',
      'Architecture patrimoniale': 'Arquitectura patrimonial',
      'Sécurité': 'Seguridad',
      'Salon de réception': 'Salón de recepción',
      'Matériaux traditionnels': 'Materiales tradicionales',
      'Emplacement Médina': 'Ubicación Medina',
      'Cachet historique': 'Carácter histórico',
      'Volumes intérieurs': 'Volúmenes interiores',
      'Accès sélection privée': 'Acceso a selección privada',
      'Potentiel locatif': 'Potencial de alquiler',
      'Rénovation premium': 'Renovación premium',
      'Sur demande': 'Previa solicitud',
      'Pré-lancement': 'Prelanzamiento',
      'Opportunité sur plan à Marrakech': 'Oportunidad sobre plano en Marrakech',
      'Pré-lancement · investissement · disponibilité limitée':
        'Prelanzamiento · inversión · disponibilidad limitada',
      'Prioritaire': 'Prioritario',
      'Projet': 'Proyecto',
      'Limitée': 'Limitada',
      ...
      'Livraison programmée': 'Entrega programada',
      'photo': 'foto',
      'photos': 'fotos',
      'extérieur': 'exterior',
      'intérieur': 'interior',
    ...
    no: {
      'Fermer la fiche': 'Lukk eiendomsfiche',
      'Navigation fiche bien': 'Navigasjon i eiendomsfiche',
      'Plans transmis sur demande': 'Planer deles på forespørsel',
      'Rappel': 'Bli oppringt',
      'Recevoir le dossier': 'Motta dokumentasjonen',
      'Villa sur plan': 'Nybyggvilla',
      'Sélection :': 'Utvalg:',
      'Projet sur plan': 'Nybyggprosjekt',
      'À partir de 351 000 €': 'Fra 351 000 €',
      '32 villas sur plan à Marrakech, avec une disponibilité limitée à 7 villas restantes.':
        '32 nybyggvillaer i Marrakech, med begrenset tilgjengelighet på 7 gjenværende villaer.',
      'Villa Jaz — villas sur plan à Marrakech':
        'Villa Jaz — nybyggvillaer i Marrakech',
      'Réserver ta villa': 'Reserver villaen din',
      'Remplir le formulaire pour plus de détails': 'Fyll ut skjemaet for mer informasjon',
      'Type': 'Type',
      'Total': 'Totalt',
      ...
      'Adresse': 'Adresse',
      'Paiement': 'Betaling',
      '32 villas': '32 villaer',
      '7 villas restantes': '7 villaer igjen',
      'Communiquée sur demande': 'Delt på forespørsel',
      '30% à la réservation, puis 30% à chaque avancement du projet':
        '30% ved reservasjon, deretter 30% ved hver prosjektmilepæl',
      'Villa Jaz est une opportunité sur plan pensée pour les acquéreurs qui recherchent une villa privée à Marrakech, avec un cadre résidentiel, des espaces extérieurs et une disponibilité volontairement limitée.':
        'Villa Jaz er en nybyggmulighet for kjøpere som søker en privat villa i Marrakech, med et boligpreget miljø, uteområder og bevisst begrenset tilgjengelighet.',
      'Le projet réunit 32 villas, dont 7 restent disponibles. Les informations détaillées, les plans, les disponibilités actualisées et les conditions précises sont communiqués après formulaire afin de préserver la confidentialité du projet.':
        'Prosjektet omfatter 32 villaer, hvorav 7 fortsatt er tilgjengelige. Detaljert informasjon, planer, oppdatert tilgjengelighet og presise vilkår deles etter skjema for å bevare prosjektets konfidensialitet.',
      '32 villas au total': '32 villaer totalt',
      'Prix à partir de 351 000 €': 'Pris fra 351 000 €',
      '30% à la réservation': '30% ved reservasjon',
      '30% à chaque avancement du projet': '30% ved hver prosjektmilepæl',
      'Adresse communiquée sur demande': 'Adresse delt på forespørsel',
      'Plans sur formulaire': 'Planer via skjema',
      'Disponibilités actualisées': 'Oppdatert tilgjengelighet',
      'Détails complets sur demande': 'Fullstendige detaljer på forespørsel',
      'Réservation sur formulaire': 'Reservasjon via skjema',
      'Informations clés': 'Nøkkelinformasjon',
      'Disponibilité limitée': 'Begrenset tilgjengelighet',
      'sur 32 villas': 'av 32 villaer',
      'Confort & équipements': 'Komfort og fasiliteter',
      'Piscine privée dans chaque villa': 'Privat basseng i hver villa',
      'Espaces verts paysagers': 'Opparbeidede grøntområder',
      'Aire de jeux pour enfants': 'Lekeområde for barn',
      'Équipements haut de gamme': 'Fasiliteter i høy standard',
      'Jardins et espaces extérieurs aménagés': 'Opparbeidede hager og uteområder',
      'Confidentialité & réservation': 'Konfidensialitet og reservasjon',
      'Résidence sécurisée': 'Sikret boligområde',
      'Sécurité et confidentialité': 'Sikkerhet og konfidensialitet',
      'Modalités de paiement': 'Betalingsvilkår',
      '30% à la réservation, puis 30% à chaque avancement du projet. Remplir le formulaire pour recevoir les détails complets.':
        '30% ved reservasjon, deretter 30% ved hver prosjektmilepæl. Fyll ut skjemaet for å motta alle detaljer.',
      'Détails sur demande': 'Detaljer på forespørsel',
      'Appartement': 'Leilighet',
      'À partir de 1,05 M MAD': 'Fra 1,05 M MAD',
      'Programme neuf sur plan': 'Nytt nybyggprogram',
      'Appartement premium à Guéliz': 'Premiumleilighet i Guéliz',
      'Studios, appartements, duplex et commerces en hyper-centre de Marrakech.':
        'Studioer, leiligheter, duplekser og butikklokaler i sentrum av Marrakech.',
      'Appartement premium à Guéliz — Guéliz hyper-centre, Marrakech':
        'Premiumleilighet i Guéliz — sentrum av Guéliz, Marrakech',
      'Réserver ton appartement': 'Reserver leiligheten din',
      'Recevoir la fiche privée': 'Motta den private fichen',
      'Studio': 'Studio',
      'Duplex': 'Dupleks',
      'Magasin commercial': 'Butikklokale',
      'Programme neuf haut standing': 'Nytt program i høy standard',
      'Localisation': 'Beliggenhet',
      'Guéliz hyper-centre, Marrakech': 'Sentrum av Guéliz, Marrakech',
      'Surfaces': 'Arealer',
      'Livraison': 'Levering',
      '2028 — 1ère livraison': '2028 — første levering',
      'Programme immobilier neuf haut standing à Guéliz, avec studios, appartements, duplex et commerces. Une adresse sélectionnée pour acheter un bien neuf en hyper-centre de Marrakech.':
        'Nytt eiendomsprogram i høy standard i Guéliz, med studioer, leiligheter, duplekser og butikklokaler. En valgt adresse for kjøp av ny eiendom i sentrum av Marrakech.',
      'Positionnement': 'Posisjonering',
      'Hyper-centre, à proximité immédiate des commerces, restaurants et services.':
        'Sentrum, med umiddelbar nærhet til butikker, restauranter og tjenester.',
      'Conception': 'Design',
      'Une esthétique sobre, raffinée et intemporelle, inspirée des codes hôteliers haut de gamme.':
        'En nøktern, raffinert og tidløs estetikk inspirert av hotellstandard i høy klasse.',
      'Projet patrimonial': 'Langsiktig verdiobjekt',
      'Un actif pensé pour habiter, préparer un pied-à-terre ou étudier une stratégie patrimoniale à Guéliz.':
        'Et objekt utformet for å bo i, forberede et pied-à-terre eller vurdere en langsiktig strategi i Guéliz.',
      'Piscines au rez-de-chaussée': 'Bassenger i første etasje',
      'Spa résidentiel': 'Boligspa',
      'Jacuzzi': 'Jacuzzi',
      'Salle de sport': 'Treningsrom',
      'Vestiaires séparés hommes / femmes': 'Separate garderober for menn / kvinner',
      'Parking titré & box privatifs': 'Titulert parkering og private boder',
      'Plans sur demande': 'Planer på forespørsel',
      'Riad': 'Riad',
      'Prix sur demande': 'Pris på forespørsel',
      'Riad privé': 'Privat riad',
      'Riad de caractère à la Médina': 'Riad med særpreg i Medina',
      'Médina · architecture · emplacement rare': 'Medina · arkitektur · sjelden beliggenhet',
      'Secteur': 'Område',
      'Médina': 'Medina',
      'Style': 'Stil',
      'Patrimoine': 'Kulturarv',
      'Accès': 'Tilgang',
      'Sélection privée': 'Privat utvalg',
      'Patio': 'Patio',
      'Terrasse': 'Terrasse',
      'Architecture patrimoniale': 'Kulturarvarkitektur',
      'Sécurité': 'Sikkerhet',
      'Salon de réception': 'Mottakssalong',
      'Matériaux traditionnels': 'Tradisjonelle materialer',
      'Emplacement Médina': 'Beliggenhet i Medina',
      'Cachet historique': 'Historisk særpreg',
      'Volumes intérieurs': 'Interiørvolumer',
      'Accès sélection privée': 'Tilgang til privat utvalg',
      'Potentiel locatif': 'Utleiepotensial',
      'Rénovation premium': 'Premium renovering',
      'Sur demande': 'På forespørsel',
      'Pré-lancement': 'Før lansering',
      'Opportunité sur plan à Marrakech': 'Nybyggmulighet i Marrakech',
      'Pré-lancement · investissement · disponibilité limitée':
        'Før lansering · investering · begrenset tilgjengelighet',
      'Prioritaire': 'Prioritert',
      'Projet': 'Prosjekt',
      'Limitée': 'Begrenset',
      'Investissement': 'Investering',
      'Accès prioritaire': 'Prioritert tilgang',
      'Piscine': 'Basseng',
      'Jardin': 'Hage',
      'Parking': 'Parkering',
      'Livraison programmée': 'Planlagt levering',
      'photo': 'bilde',
      'photos': 'bilder',
      'extérieur': 'eksteriør',
      'intérieur': 'interiør',
  ...
  function getCurrentLocale() {
    ...
    if (htmlLang.indexOf('es') === 0 || pathLang === 'es') return 'es';
    if (htmlLang.indexOf('nl') === 0 || pathLang === 'nl') return 'nl';
    if (htmlLang.indexOf('it') === 0 || pathLang === 'it') return 'it';
    if (htmlLang.indexOf('no') === 0 || htmlLang.indexOf('nb') === 0 || pathLang === 'no') return 'no';
