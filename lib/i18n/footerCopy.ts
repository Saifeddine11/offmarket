...
const EN: FooterCopy = {
  ...
  immobilierLinks: [
    ...
    { label: "Villas in Marrakech", href: "/nos-projets/" },
    { label: "Apartments in Marrakech", href: "/nos-projets/" },
...
const NL: FooterCopy = {
  ...FR,
  brandHeadline: "Privé vastgoed in Marrakech.",
  brandSupport:
    "Een vertrouwelijke selectie van villa's, appartementen, nieuwbouwprojecten en off-market kansen.",
  newsletterTitle: "Ontvang privé-opportuniteiten",
  newsletterText: "Blijf op de hoogte van nieuwe geselecteerde projecten in Marrakech.",
  newsletterPlaceholder: "uw@email.com",
  newsletterButton: "Inschrijven",
  newsletterSuccess: "Dank u. Uw aanvraag wordt geopend in uw mailprogramma.",
  navLinks: [
    { label: "Home", href: "/nl/" },
  ...
  immobilierLinks: [
    { label: "Off-market", href: "/off-market/" },
    { label: "Villa's in Marrakech", href: "/nos-projets/" },
    { label: "Appartementen in Marrakech", href: "/nos-projets/" },
    { label: "Nieuwbouw kopen", href: "/nl/nieuwbouw/" },
    { label: "Investeringssimulator", href: "/simulateur/" },
    { label: "Blog", href: "/blog/" },
  ],
